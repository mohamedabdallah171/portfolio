...
function Home() {
  ...
  const sendEmail = (e) => {
    ...
    e.preventDefault();
    emailjs.sendForm('service_av2ex4f', 'template_qqt0qkq', form.current, 'KWWXGEbDgc7AAEa6m')
      .then((result) => {
        ...
        <Container>
          <Row>
            <Col md={7} sm={12} className="bannartext wow slideInLeft" data-wow-duration="2s" data-wow-delay="0.1s">
              ...
              <h1>Mohamed Abdallah Portfolio .</h1>
        ...
        <Container>
          ...
          <Row className="align-items-center">
            <Col md={6} sm={12} className="wow slideInLeft" data-wow-duration="2s" data-wow-delay="0.1s">
              <div>
                <p><span>Email:</span> mohamedabdallahma9001071@gmail.com</p>
                <p><span>Phone:</span> 01094650622</p>
